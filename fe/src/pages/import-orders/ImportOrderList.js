...
const ImportOrderList = () => {
    ...
    const handleEditOrder = async (updatedOrder, orderId) => {
        try {
            ...
            message.success("Import order updated successfully!");
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    {record.Status === "New" && (
                        <>
                            <Button onClick={() => showEditOrderModal(record.ImportOrderId)}>Edit</Button>
                            <Button onClick={() => showDeleteOrderModal(record)} danger>Delete</Button>
                        </>
                    )}
                </Space>
            ),
