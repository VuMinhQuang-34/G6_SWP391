...
const ApproveWMSImportOrderModal = ({ visible, onCancel, onEdit, suppliers, books, order }) => {
    ...
    const handleApprove = async (action) => {
        ...
        //await onEdit({...order, Status: "ApproveImport", FaultBooks: selectedFaultBooks, LogNote: values.LogNote}, order.ImportOrderId);
        await onEdit({...order, Status: "ApproveImport", FaultBooks: selectedFaultBooks, LogNote: action}, order.ImportOrderId);
